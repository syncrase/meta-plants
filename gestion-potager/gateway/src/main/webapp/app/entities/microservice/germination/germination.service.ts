...
type EntityResponseType = HttpResponse<IGermination>;
type EntityArrayResponseType = HttpResponse<IGermination[]>;

@Injectable({ providedIn: 'root' })
export class GerminationService {
  public resourceUrl = SERVER_API_URL + 'services/microservice/api/germinations';
  ...
  update(germination: IGermination): Observable<EntityResponseType> {
    return this.http.put<IGermination>(this.resourceUrl, germination, { observe: 'response' });
  }
