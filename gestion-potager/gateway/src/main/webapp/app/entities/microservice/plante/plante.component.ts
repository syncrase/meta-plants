...
export class PlanteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.planteService
      ...
      .subscribe(
        (res: HttpResponse<IPlante[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPlantes(): void {
    this.eventSubscriber = this.eventManager.subscribe('planteListModification', () => this.loadPage());
  }
