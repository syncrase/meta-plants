...
describe('Ressemblance Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Plante query and add missing value', () => {
      ...
      const confusion: IPlante = { id: 63187 };
      ressemblance.confusion = confusion;
      ...
      const additionalPlantes = [confusion];
    ...
    it('Should update editForm', () => {
      const ressemblance: IRessemblance = { id: 456 };
      const confusion: IPlante = { id: 74404 };
      ressemblance.confusion = confusion;
      ...
      expect(comp.plantesSharedCollection).toContain(confusion);
    });
  });
