...
class UserResourceIT {
    ...
    public static void deleteEntities(EntityManager em) {
        try {
            em.deleteAll("gp_user_authority").block();
