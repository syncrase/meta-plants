...
import { PlanteComponent } from 'app/entities/microservice/plante/plante.component';
...
describe('Component Tests', () => {
  describe('Plante Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.plantes && comp.plantes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
