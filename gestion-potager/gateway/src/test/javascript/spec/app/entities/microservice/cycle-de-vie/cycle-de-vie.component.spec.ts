...
import { CycleDeVieComponent } from 'app/entities/microservice/cycle-de-vie/cycle-de-vie.component';
...
describe('Component Tests', () => {
  describe('CycleDeVie Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cycleDeVies && comp.cycleDeVies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
