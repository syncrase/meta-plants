...
import { GerminationComponent } from 'app/entities/microservice/germination/germination.component';
...
describe('Component Tests', () => {
  describe('Germination Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.germinations && comp.germinations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
