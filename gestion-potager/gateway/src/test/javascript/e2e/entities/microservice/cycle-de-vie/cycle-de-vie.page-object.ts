...
export class CycleDeVieComponentsPage {
  ...
  deleteButtons = element.all(by.css('gp-cycle-de-vie div table .btn-danger'));
  title = element.all(by.css('gp-cycle-de-vie div h2#page-heading span')).first();
...
export class CycleDeVieUpdatePage {
  pageTitle = element(by.id('gp-cycle-de-vie-heading'));
...
export class CycleDeVieDeleteDialog {
  private dialogTitle = element(by.id('gp-delete-cycleDeVie-heading'));
