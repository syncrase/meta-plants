...
describe('Temperature e2e test', () => {
  ...
  it('should load Temperatures', async () => {
    ...
    expect(await temperatureComponentsPage.getTitle()).to.eq('gatewayApp.microserviceTemperature.home.title');
    await browser.wait(
  ...
  it('should load create Temperature page', async () => {
    ...
    expect(await temperatureUpdatePage.getPageTitle()).to.eq('gatewayApp.microserviceTemperature.home.createOrEditLabel');
  ...
  it('should delete last Temperature', async () => {
    ...
    expect(await temperatureDeleteDialog.getDialogTitle()).to.eq('gatewayApp.microserviceTemperature.delete.question');
