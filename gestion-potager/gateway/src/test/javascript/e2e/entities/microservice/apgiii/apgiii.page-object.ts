...
export class APGIIIComponentsPage {
  ...
  deleteButtons = element.all(by.css('gp-apgiii div table .btn-danger'));
  title = element.all(by.css('gp-apgiii div h2#page-heading span')).first();
...
export class APGIIIUpdatePage {
  pageTitle = element(by.id('gp-apgiii-heading'));
...
export class APGIIIDeleteDialog {
  private dialogTitle = element(by.id('gp-delete-aPGIII-heading'));
  private confirmButton = element(by.id('gp-confirm-delete-aPGIII'));
