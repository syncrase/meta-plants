...
describe('Reproduction e2e test', () => {
  ...
  it('should load Reproductions', async () => {
    ...
    expect(await reproductionComponentsPage.getTitle()).to.eq('gatewayApp.microserviceReproduction.home.title');
    await browser.wait(
  ...
  it('should load create Reproduction page', async () => {
    ...
    expect(await reproductionUpdatePage.getPageTitle()).to.eq('gatewayApp.microserviceReproduction.home.createOrEditLabel');
  ...
  it('should delete last Reproduction', async () => {
    ...
    expect(await reproductionDeleteDialog.getDialogTitle()).to.eq('gatewayApp.microserviceReproduction.delete.question');
