...
class EnsoleillementResourceIT {
    ...
    void putNewEnsoleillement() throws Exception {
        ...
        restEnsoleillementMockMvc
            .perform(
                put(ENTITY_API_URL_ID, ensoleillementDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(ensoleillementDTO))
            )
    ...
    void patchNonExistingEnsoleillement() throws Exception {
        ...
        restEnsoleillementMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, ensoleillementDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(ensoleillementDTO))
            )
    ...
    void deleteEnsoleillement() throws Exception {
        ...
        restEnsoleillementMockMvc
            .perform(delete(ENTITY_API_URL_ID, ensoleillement.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
