...
import fr.syncrase.perma.config.audit.AuditEventConverter;
import fr.syncrase.perma.domain.PersistentAuditEvent;
...
import static fr.syncrase.perma.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
