...
class CycleDeVieResourceIT {
    ...
    void putNewCycleDeVie() throws Exception {
        ...
        restCycleDeVieMockMvc
            .perform(
                put(ENTITY_API_URL_ID, cycleDeVieDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(cycleDeVieDTO))
            )
    ...
    void patchNonExistingCycleDeVie() throws Exception {
        ...
        restCycleDeVieMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, cycleDeVieDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(cycleDeVieDTO))
            )
    ...
    void deleteCycleDeVie() throws Exception {
        ...
        restCycleDeVieMockMvc
            .perform(delete(ENTITY_API_URL_ID, cycleDeVie.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
