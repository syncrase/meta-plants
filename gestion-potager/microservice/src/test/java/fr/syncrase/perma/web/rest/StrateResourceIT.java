...
class StrateResourceIT {
    ...
    void putNewStrate() throws Exception {
        ...
        restStrateMockMvc
            .perform(
                put(ENTITY_API_URL_ID, strateDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(strateDTO))
            )
    ...
    void patchNonExistingStrate() throws Exception {
        ...
        restStrateMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, strateDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(strateDTO))
            )
    ...
    void deleteStrate() throws Exception {
        ...
        // Delete the strate
        restStrateMockMvc
            .perform(delete(ENTITY_API_URL_ID, strate.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
