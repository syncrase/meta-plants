package fr.syncrase.perma.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import fr.syncrase.perma.IntegrationTest;
import fr.syncrase.perma.repository.timezone.DateTimeWrapper;
import fr.syncrase.perma.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM perma_date_time_wrapper where id=%d", fieldName, id);
    }
