...
class ReproductionResourceIT {
        ...
        restReproductionMockMvc
            .perform(
                post(ENTITY_API_URL)
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(reproductionDTO))
            )
    ...
    void putNewReproduction() throws Exception {
        ...
        ReproductionDTO reproductionDTO = reproductionMapper.toDto(updatedReproduction);

        restReproductionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, reproductionDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(reproductionDTO))
            )
    ...
    void patchNonExistingReproduction() throws Exception {
        ...
        restReproductionMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, reproductionDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(reproductionDTO))
            )
    ...
    void deleteReproduction() throws Exception {
        ...
        restReproductionMockMvc
            .perform(delete(ENTITY_API_URL_ID, reproduction.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
