...
class StrateGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Strate entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/strates")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new strate")
            .post("/services/microservice/api/strates")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "type":"SAMPLE_TEXT"
                }""")).asJson
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_strate_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created strate")
            .delete("/services/microservice${new_strate_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
