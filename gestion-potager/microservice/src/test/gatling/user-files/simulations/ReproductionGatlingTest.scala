...
class ReproductionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Reproduction entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/reproductions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new reproduction")
            .post("/services/microservice/api/reproductions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "vitesse":"SAMPLE_TEXT"
                , "type":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_reproduction_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created reproduction")
            .delete("/services/microservice${new_reproduction_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
