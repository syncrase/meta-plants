...
class FeuillageGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Feuillage entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/feuillages")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new feuillage")
            .post("/services/microservice/api/feuillages")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "type":"SAMPLE_TEXT"
                }""")).asJson
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_feuillage_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created feuillage")
            .delete("/services/microservice${new_feuillage_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
