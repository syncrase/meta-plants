...
class RacineGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Racine entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/racines")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new racine")
            .post("/services/microservice/api/racines")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "type":"SAMPLE_TEXT"
                }""")).asJson
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_racine_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created racine")
            .delete("/services/microservice${new_racine_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
