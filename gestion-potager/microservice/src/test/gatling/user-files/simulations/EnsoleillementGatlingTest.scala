...
class EnsoleillementGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Ensoleillement entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/ensoleillements")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new ensoleillement")
            .post("/services/microservice/api/ensoleillements")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_ensoleillement_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created ensoleillement")
            .delete("/services/microservice${new_ensoleillement_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
