...
class PeriodeAnneeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PeriodeAnnee entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/periode-annees")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new periodeAnnee")
            .post("/services/microservice/api/periode-annees")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                }""")).asJson
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_periodeAnnee_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created periodeAnnee")
            .delete("/services/microservice${new_periodeAnnee_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
