...
class SemisGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Semis entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/semis")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new semis")
            .post("/services/microservice/api/semis")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                }""")).asJson
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_semis_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created semis")
            .delete("/services/microservice${new_semis_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
