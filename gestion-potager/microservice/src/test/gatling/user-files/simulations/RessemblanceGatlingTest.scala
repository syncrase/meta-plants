...
class RessemblanceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Ressemblance entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/ressemblances")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new ressemblance")
            .post("/services/microservice/api/ressemblances")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_ressemblance_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created ressemblance")
            .delete("/services/microservice${new_ressemblance_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
