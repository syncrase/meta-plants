...
/**
 * Criteria class for the {@link fr.syncrase.perma.domain.Ensoleillement} entity. This class is used
 * in {@link fr.syncrase.perma.web.rest.EnsoleillementResource} to receive all the possible filtering options from
