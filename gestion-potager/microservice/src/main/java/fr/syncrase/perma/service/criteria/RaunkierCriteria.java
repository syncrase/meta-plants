...
/**
 * Criteria class for the {@link fr.syncrase.perma.domain.Raunkier} entity. This class is used
 * in {@link fr.syncrase.perma.web.rest.RaunkierResource} to receive all the possible filtering options from
