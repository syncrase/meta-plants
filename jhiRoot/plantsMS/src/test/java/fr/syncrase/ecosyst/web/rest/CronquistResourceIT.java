...
class CronquistResourceIT {
    ...
    void createCronquist() throws Exception {
        ...
        restCronquistMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(cronquist)))
    ...
    void putNewCronquist() throws Exception {
        ...
        restCronquistMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCronquist.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedCronquist))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingCronquist() throws Exception {
        ...
        restCronquistMockMvc
            .perform(
                put(ENTITY_API_URL_ID, cronquist.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(cronquist))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamCronquist() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCronquistMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(cronquist)))
    ...
    void patchNonExistingCronquist() throws Exception {
        ...
        restCronquistMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, cronquist.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(cronquist))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCronquist() throws Exception {
        ...
        restCronquistMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(cronquist))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteCronquist() throws Exception {
        ...
        restCronquistMockMvc
            .perform(delete(ENTITY_API_URL_ID, cronquist.getId()).accept(MediaType.APPLICATION_JSON))
