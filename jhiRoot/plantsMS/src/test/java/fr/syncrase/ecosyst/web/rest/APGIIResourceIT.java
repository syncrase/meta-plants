...
class APGIIResourceIT {
    ...
    void createAPGII() throws Exception {
        ...
        // Create the APGII
        restAPGIIMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(aPGII)))
    ...
    void putNewAPGII() throws Exception {
        ...
        restAPGIIMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAPGII.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedAPGII))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAPGII() throws Exception {
        ...
        restAPGIIMockMvc
            .perform(
                put(ENTITY_API_URL_ID, aPGII.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(aPGII))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAPGII() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAPGIIMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(aPGII)))
    ...
    void patchNonExistingAPGII() throws Exception {
        ...
        restAPGIIMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, aPGII.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(aPGII))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAPGII() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAPGIIMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(aPGII)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteAPGII() throws Exception {
        ...
        // Delete the aPGII
        restAPGIIMockMvc
            .perform(delete(ENTITY_API_URL_ID, aPGII.getId()).accept(MediaType.APPLICATION_JSON))
