...
public class ReproductionResource {
    ...
    private static final String ENTITY_NAME = "plantsMsReproduction";
    ...
    public ResponseEntity<Reproduction> updateReproduction(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reproduction.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Reproduction> partialUpdateReproduction(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reproduction.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Reproduction>> getAllReproductions(ReproductionCriteria criteria, Pageable pageable) {
