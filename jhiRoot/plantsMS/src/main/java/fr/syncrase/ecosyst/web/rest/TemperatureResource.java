...
public class TemperatureResource {
    ...
    private static final String ENTITY_NAME = "plantsMsTemperature";
    ...
    public ResponseEntity<Temperature> updateTemperature(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, temperature.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Temperature> partialUpdateTemperature(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, temperature.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Temperature>> getAllTemperatures(TemperatureCriteria criteria, Pageable pageable) {
