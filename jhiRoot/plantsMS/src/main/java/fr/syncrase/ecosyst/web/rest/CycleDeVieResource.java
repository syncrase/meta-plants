...
public class CycleDeVieResource {
    ...
    private static final String ENTITY_NAME = "plantsMsCycleDeVie";
    ...
    public ResponseEntity<CycleDeVie> updateCycleDeVie(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cycleDeVie.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CycleDeVie> partialUpdateCycleDeVie(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cycleDeVie.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<CycleDeVie>> getAllCycleDeVies(CycleDeVieCriteria criteria, Pageable pageable) {
