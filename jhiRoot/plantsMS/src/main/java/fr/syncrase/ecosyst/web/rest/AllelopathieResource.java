...
public class AllelopathieResource {
    ...
    private static final String ENTITY_NAME = "plantsMsAllelopathie";
    ...
    public ResponseEntity<Allelopathie> updateAllelopathie(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, allelopathie.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Allelopathie> partialUpdateAllelopathie(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, allelopathie.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Allelopathie>> getAllAllelopathies(AllelopathieCriteria criteria, Pageable pageable) {
