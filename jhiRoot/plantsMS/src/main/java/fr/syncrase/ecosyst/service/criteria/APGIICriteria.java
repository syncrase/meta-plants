...
/**
 * Criteria class for the {@link fr.syncrase.ecosyst.domain.APGII} entity. This class is used
 * in {@link fr.syncrase.ecosyst.web.rest.APGIIResource} to receive all the possible filtering options from
