...
public class PeriodeAnneeResource {
    ...
    private static final String ENTITY_NAME = "plantsMsPeriodeAnnee";
    ...
    public ResponseEntity<PeriodeAnnee> updatePeriodeAnnee(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, periodeAnnee.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PeriodeAnnee> partialUpdatePeriodeAnnee(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, periodeAnnee.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<PeriodeAnnee>> getAllPeriodeAnnees(PeriodeAnneeCriteria criteria, Pageable pageable) {
