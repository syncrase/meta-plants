...
public class NomVernaculaireResource {
    ...
    private static final String ENTITY_NAME = "plantsMsNomVernaculaire";
    ...
    public ResponseEntity<NomVernaculaire> updateNomVernaculaire(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, nomVernaculaire.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<NomVernaculaire> partialUpdateNomVernaculaire(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, nomVernaculaire.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<NomVernaculaire>> getAllNomVernaculaires(NomVernaculaireCriteria criteria, Pageable pageable) {
