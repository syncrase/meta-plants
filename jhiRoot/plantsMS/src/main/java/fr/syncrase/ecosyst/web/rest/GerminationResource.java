...
public class GerminationResource {
    ...
    private static final String ENTITY_NAME = "plantsMsGermination";
    ...
    public ResponseEntity<Germination> updateGermination(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, germination.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Germination> partialUpdateGermination(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, germination.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Germination>> getAllGerminations(GerminationCriteria criteria, Pageable pageable) {
