...
public class FeuillageResource {
    ...
    private static final String ENTITY_NAME = "plantsMsFeuillage";
    ...
    public ResponseEntity<Feuillage> updateFeuillage(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, feuillage.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Feuillage> partialUpdateFeuillage(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, feuillage.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Feuillage>> getAllFeuillages(FeuillageCriteria criteria, Pageable pageable) {
