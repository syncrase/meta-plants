...
public class SemisResource {
    ...
    private static final String ENTITY_NAME = "plantsMsSemis";
    ...
    public ResponseEntity<Semis> updateSemis(@PathVariable(value = "id", required = false) final Long id, @RequestBody Semis semis)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, semis.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Semis> partialUpdateSemis(@PathVariable(value = "id", required = false) final Long id, @RequestBody Semis semis)
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, semis.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/semis")
    public ResponseEntity<List<Semis>> getAllSemis(SemisCriteria criteria, Pageable pageable) {
