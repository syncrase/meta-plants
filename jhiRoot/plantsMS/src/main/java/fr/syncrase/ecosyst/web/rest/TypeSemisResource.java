...
public class TypeSemisResource {
    ...
    private static final String ENTITY_NAME = "plantsMsTypeSemis";
    ...
    public ResponseEntity<TypeSemis> updateTypeSemis(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeSemis.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TypeSemis> partialUpdateTypeSemis(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeSemis.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<TypeSemis>> getAllTypeSemis(TypeSemisCriteria criteria, Pageable pageable) {
