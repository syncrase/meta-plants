...
public class RacineResource {
    ...
    private static final String ENTITY_NAME = "plantsMsRacine";
    ...
    public ResponseEntity<Racine> updateRacine(@PathVariable(value = "id", required = false) final Long id, @RequestBody Racine racine)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, racine.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Racine> partialUpdateRacine(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, racine.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/racines")
    public ResponseEntity<List<Racine>> getAllRacines(RacineCriteria criteria, Pageable pageable) {
