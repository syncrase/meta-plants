...
/**
 * Criteria class for the {@link fr.syncrase.ecosyst.domain.APGI} entity. This class is used
 * in {@link fr.syncrase.ecosyst.web.rest.APGIResource} to receive all the possible filtering options from
