...
public class ClassificationResource {
    ...
    private static final String ENTITY_NAME = "plantsMsClassification";
    ...
    public ResponseEntity<List<Classification>> getAllClassifications(ClassificationCriteria criteria, Pageable pageable) {
