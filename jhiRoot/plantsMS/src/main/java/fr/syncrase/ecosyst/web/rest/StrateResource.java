...
public class StrateResource {
    ...
    private static final String ENTITY_NAME = "plantsMsStrate";
    ...
    public ResponseEntity<Strate> updateStrate(@PathVariable(value = "id", required = false) final Long id, @RequestBody Strate strate)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, strate.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Strate> partialUpdateStrate(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, strate.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/strates")
    public ResponseEntity<List<Strate>> getAllStrates(StrateCriteria criteria, Pageable pageable) {
