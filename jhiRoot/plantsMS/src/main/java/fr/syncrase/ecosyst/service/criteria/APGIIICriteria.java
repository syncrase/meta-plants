...
/**
 * Criteria class for the {@link fr.syncrase.ecosyst.domain.APGIII} entity. This class is used
 * in {@link fr.syncrase.ecosyst.web.rest.APGIIIResource} to receive all the possible filtering options from
