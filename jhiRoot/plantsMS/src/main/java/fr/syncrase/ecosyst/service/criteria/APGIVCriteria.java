...
/**
 * Criteria class for the {@link fr.syncrase.ecosyst.domain.APGIV} entity. This class is used
 * in {@link fr.syncrase.ecosyst.web.rest.APGIVResource} to receive all the possible filtering options from
