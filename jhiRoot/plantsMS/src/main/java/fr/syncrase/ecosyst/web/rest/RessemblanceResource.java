...
public class RessemblanceResource {
    ...
    private static final String ENTITY_NAME = "plantsMsRessemblance";
    ...
    public ResponseEntity<Ressemblance> updateRessemblance(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ressemblance.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Ressemblance> partialUpdateRessemblance(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ressemblance.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Ressemblance>> getAllRessemblances(RessemblanceCriteria criteria, Pageable pageable) {
