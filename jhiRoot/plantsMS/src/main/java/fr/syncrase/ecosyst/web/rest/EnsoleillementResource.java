...
public class EnsoleillementResource {
    ...
    private static final String ENTITY_NAME = "plantsMsEnsoleillement";
    ...
    public ResponseEntity<Ensoleillement> updateEnsoleillement(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ensoleillement.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Ensoleillement> partialUpdateEnsoleillement(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ensoleillement.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Ensoleillement>> getAllEnsoleillements(EnsoleillementCriteria criteria, Pageable pageable) {
