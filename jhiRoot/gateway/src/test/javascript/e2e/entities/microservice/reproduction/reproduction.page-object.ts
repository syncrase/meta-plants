...
export class ReproductionComponentsPage {
  ...
  deleteButtons = element.all(by.css('gp-reproduction div table .btn-danger'));
  title = element.all(by.css('gp-reproduction div h2#page-heading span')).first();
...
export class ReproductionUpdatePage {
  pageTitle = element(by.id('gp-reproduction-heading'));
...
export class ReproductionDeleteDialog {
  private dialogTitle = element(by.id('gp-delete-reproduction-heading'));
  private confirmButton = element(by.id('gp-confirm-delete-reproduction'));
