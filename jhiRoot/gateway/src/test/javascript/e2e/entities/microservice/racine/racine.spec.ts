...
describe('Racine e2e test', () => {
  ...
  it('should load Racines', async () => {
    ...
    expect(await racineComponentsPage.getTitle()).to.eq('gatewayApp.microserviceRacine.home.title');
  ...
  it('should load create Racine page', async () => {
    ...
    expect(await racineUpdatePage.getPageTitle()).to.eq('gatewayApp.microserviceRacine.home.createOrEditLabel');
  ...
  it('should delete last Racine', async () => {
    ...
    expect(await racineDeleteDialog.getDialogTitle()).to.eq('gatewayApp.microserviceRacine.delete.question');
