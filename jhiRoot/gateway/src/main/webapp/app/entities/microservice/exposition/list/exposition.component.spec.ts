...
describe('Exposition Management Component', () => {
  let comp: ExpositionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ExpositionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.expositions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
