...
export class RessemblanceUpdateComponent implements OnInit {
  ...
  protected updateForm(ressemblance: IRessemblance): void {
    this.editForm.patchValue({
      ...
      confusion: ressemblance.confusion,
    });

    this.plantesSharedCollection = this.planteService.addPlanteToCollectionIfMissing(this.plantesSharedCollection, ressemblance.confusion);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.planteService
      ...
      .pipe(map((plantes: IPlante[]) => this.planteService.addPlanteToCollectionIfMissing(plantes, this.editForm.get('confusion')!.value)))
  ...
  protected createFromForm(): IRessemblance {
    return {
      ...
      confusion: this.editForm.get(['confusion'])!.value,
    };
  }
}
