...
import { IClassification, getClassificationIdentifier } from '../classification.model';
...
export class ClassificationService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/classifications', 'microservice');
