...
describe('SousClasse Management Component', () => {
  let comp: SousClasseComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SousClasseComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sousClasses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
