...
import { RegneComponent } from './regne.component';

describe('Regne Management Component', () => {
  let comp: RegneComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(RegneComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.regnes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
