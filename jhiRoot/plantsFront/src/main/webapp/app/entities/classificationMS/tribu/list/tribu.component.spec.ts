...
describe('Tribu Management Component', () => {
  let comp: TribuComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TribuComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tribus?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
