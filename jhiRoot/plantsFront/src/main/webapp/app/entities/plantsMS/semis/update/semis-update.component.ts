...
import { IPeriodeAnnee } from 'app/entities/plantsMS/periode-annee/periode-annee.model';
import { PeriodeAnneeService } from 'app/entities/plantsMS/periode-annee/service/periode-annee.service';
import { ITypeSemis } from 'app/entities/plantsMS/type-semis/type-semis.model';
import { TypeSemisService } from 'app/entities/plantsMS/type-semis/service/type-semis.service';
import { IGermination } from 'app/entities/plantsMS/germination/germination.model';
import { GerminationService } from 'app/entities/plantsMS/germination/service/germination.service';

@Component({
  selector: 'perma-semis-update',
