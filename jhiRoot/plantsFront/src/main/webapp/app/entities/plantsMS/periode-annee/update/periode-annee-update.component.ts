...
import { IMois } from 'app/entities/plantsMS/mois/mois.model';
import { MoisService } from 'app/entities/plantsMS/mois/service/mois.service';

@Component({
  selector: 'perma-periode-annee-update',
