...
export class ClassificationCronquistComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('perma-classification-cronquist div table .btn-danger'));
  title = element.all(by.css('perma-classification-cronquist div h2#page-heading span')).first();
...
export class ClassificationCronquistUpdatePage {
  pageTitle = element(by.id('perma-classification-cronquist-heading'));
  ...
  superEmbranchementInput = element(by.id('field_superEmbranchement'));
  divisionInput = element(by.id('field_division'));
  sousEmbranchementInput = element(by.id('field_sousEmbranchement'));
  ...
  async setSuperEmbranchementInput(superEmbranchement: string): Promise<void> {
    await this.superEmbranchementInput.sendKeys(superEmbranchement);
  }

  async getSuperEmbranchementInput(): Promise<string> {
    return await this.superEmbranchementInput.getAttribute('value');
  }
  ...
  async setSousEmbranchementInput(sousEmbranchement: string): Promise<void> {
    await this.sousEmbranchementInput.sendKeys(sousEmbranchement);
  }

  async getSousEmbranchementInput(): Promise<string> {
    return await this.sousEmbranchementInput.getAttribute('value');
  }
...
export class ClassificationCronquistDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-classificationCronquist-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-classificationCronquist'));
