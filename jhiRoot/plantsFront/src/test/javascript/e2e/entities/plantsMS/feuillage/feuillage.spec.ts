...
describe('Feuillage e2e test', () => {
  ...
  it('should load Feuillages', async () => {
    ...
    expect(await feuillageComponentsPage.getTitle()).to.eq('Feuillages');
  ...
  it('should load create Feuillage page', async () => {
    ...
    expect(await feuillageUpdatePage.getPageTitle()).to.eq('Create or edit a Feuillage');
  ...
  it('should delete last Feuillage', async () => {
    ...
    expect(await feuillageDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Feuillage?');
