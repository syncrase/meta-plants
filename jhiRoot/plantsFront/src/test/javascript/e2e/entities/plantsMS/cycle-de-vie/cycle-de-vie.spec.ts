...
describe('CycleDeVie e2e test', () => {
  ...
  it('should load CycleDeVies', async () => {
    ...
    expect(await cycleDeVieComponentsPage.getTitle()).to.eq('Cycle De Vies');
  ...
  it('should load create CycleDeVie page', async () => {
    ...
    expect(await cycleDeVieUpdatePage.getPageTitle()).to.eq('Create or edit a Cycle De Vie');
  ...
  it('should delete last CycleDeVie', async () => {
    ...
    expect(await cycleDeVieDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Cycle De Vie?');
