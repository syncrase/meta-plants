...
describe('PeriodeAnnee e2e test', () => {
  ...
  it('should load PeriodeAnnees', async () => {
    ...
    expect(await periodeAnneeComponentsPage.getTitle()).to.eq('Periode Annees');
    await browser.wait(
  ...
  it('should load create PeriodeAnnee page', async () => {
    ...
    expect(await periodeAnneeUpdatePage.getPageTitle()).to.eq('Create or edit a Periode Annee');
  ...
  /* it('should delete last PeriodeAnnee', async () => {
        ...
        expect(await periodeAnneeDeleteDialog.getDialogTitle())
            .to.eq('Are you sure you want to delete this Periode Annee?');
