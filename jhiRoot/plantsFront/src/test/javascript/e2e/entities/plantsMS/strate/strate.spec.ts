...
describe('Strate e2e test', () => {
  ...
  it('should load Strates', async () => {
    ...
    expect(await strateComponentsPage.getTitle()).to.eq('Strates');
  ...
  it('should load create Strate page', async () => {
    ...
    expect(await strateUpdatePage.getPageTitle()).to.eq('Create or edit a Strate');
  ...
  it('should delete last Strate', async () => {
    ...
    expect(await strateDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Strate?');
