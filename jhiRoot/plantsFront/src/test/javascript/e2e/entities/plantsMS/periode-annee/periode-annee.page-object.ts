...
export class PeriodeAnneeComponentsPage {
  ...
  deleteButtons = element.all(by.css('perma-periode-annee div table .btn-danger'));
  title = element.all(by.css('perma-periode-annee div h2#page-heading span')).first();
...
export class PeriodeAnneeUpdatePage {
  pageTitle = element(by.id('perma-periode-annee-heading'));
...
export class PeriodeAnneeDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-periodeAnnee-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-periodeAnnee'));
