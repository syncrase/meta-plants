...
describe('Classification e2e test', () => {
  ...
  it('should load Classifications', async () => {
    ...
    expect(await classificationComponentsPage.getTitle()).to.eq('Classifications');
    await browser.wait(
  ...
  it('should load create Classification page', async () => {
    ...
    expect(await classificationUpdatePage.getPageTitle()).to.eq('Create or edit a Classification');
  ...
  it('should delete last Classification', async () => {
    ...
    expect(await classificationDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Classification?');
