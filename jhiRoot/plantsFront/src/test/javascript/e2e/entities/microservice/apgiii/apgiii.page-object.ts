...
export class APGIIIComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('perma-apgiii div table .btn-danger'));
  title = element.all(by.css('perma-apgiii div h2#page-heading span')).first();
...
export class APGIIIUpdatePage {
  pageTitle = element(by.id('perma-apgiii-heading'));
...
export class APGIIIDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-aPGIII-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-aPGIII'));
