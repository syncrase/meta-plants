...
export class APGIComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('perma-apgi div table .btn-danger'));
  title = element.all(by.css('perma-apgi div h2#page-heading span')).first();
...
export class APGIUpdatePage {
  pageTitle = element(by.id('perma-apgi-heading'));
...
export class APGIDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-aPGI-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-aPGI'));
