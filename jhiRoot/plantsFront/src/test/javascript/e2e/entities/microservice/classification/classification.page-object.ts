...
export class ClassificationComponentsPage {
  ...
  deleteButtons = element.all(by.css('perma-classification div table .btn-danger'));
  title = element.all(by.css('perma-classification div h2#page-heading span')).first();
...
export class ClassificationUpdatePage {
  pageTitle = element(by.id('perma-classification-heading'));
...
export class ClassificationDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-classification-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-classification'));
