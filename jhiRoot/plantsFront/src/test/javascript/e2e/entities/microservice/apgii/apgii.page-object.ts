...
export class APGIIComponentsPage {
  ...
  deleteButtons = element.all(by.css('perma-apgii div table .btn-danger'));
  title = element.all(by.css('perma-apgii div h2#page-heading span')).first();
...
export class APGIIUpdatePage {
  pageTitle = element(by.id('perma-apgii-heading'));
...
export class APGIIDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-aPGII-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-aPGII'));
