...
describe('APGIII e2e test', () => {
  ...
  it('should load APGIIIS', async () => {
    ...
    expect(await aPGIIIComponentsPage.getTitle()).to.eq('APGIIIS');
  ...
  it('should load create APGIII page', async () => {
    ...
    expect(await aPGIIIUpdatePage.getPageTitle()).to.eq('Create or edit a APGIII');
  ...
  it('should delete last APGIII', async () => {
    ...
    expect(await aPGIIIDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this APGIII?');
