...
export class InfraClasseComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('perma-infra-classe div table .btn-danger'));
  title = element.all(by.css('perma-infra-classe div h2#page-heading span')).first();
...
export class InfraClasseUpdatePage {
  pageTitle = element(by.id('perma-infra-classe-heading'));
...
export class InfraClasseDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-infraClasse-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-infraClasse'));
