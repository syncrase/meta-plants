...
export class InfraRegneComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('perma-infra-regne div table .btn-danger'));
  title = element.all(by.css('perma-infra-regne div h2#page-heading span')).first();
...
export class InfraRegneUpdatePage {
  pageTitle = element(by.id('perma-infra-regne-heading'));
...
export class InfraRegneDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-infraRegne-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-infraRegne'));
