...
export class MicroOrdreComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('perma-micro-ordre div table .btn-danger'));
  title = element.all(by.css('perma-micro-ordre div h2#page-heading span')).first();
...
export class MicroOrdreUpdatePage {
  pageTitle = element(by.id('perma-micro-ordre-heading'));
...
export class MicroOrdreDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-microOrdre-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-microOrdre'));
