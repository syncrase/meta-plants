...
describe('Division e2e test', () => {
  ...
  it('should create and save Divisions', async () => {
    ...
    await promise.all([
      divisionUpdatePage.setNomFrInput('nomFr'),
      divisionUpdatePage.setNomLatinInput('nomLatin'),
      divisionUpdatePage.superDivisionSelectLastOption(),
      divisionUpdatePage.divisionSelectLastOption(),
    ]);
