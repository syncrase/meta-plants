...
import {
  CronquistRankComponentsPage,
  /* CronquistRankDeleteDialog, */
  CronquistRankUpdatePage,
} from './cronquist-rank.page-object';
...
describe('CronquistRank e2e test', () => {
  ...
  /* it('should delete last CronquistRank', async () => {
        ...
        expect(await cronquistRankDeleteDialog.getDialogTitle())
            .to.eq('Are you sure you want to delete this Cronquist Rank?');
