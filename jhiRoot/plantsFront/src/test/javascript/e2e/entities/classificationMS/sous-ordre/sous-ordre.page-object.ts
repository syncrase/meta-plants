...
export class SousOrdreComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('perma-sous-ordre div table .btn-danger'));
  title = element.all(by.css('perma-sous-ordre div h2#page-heading span')).first();
...
export class SousOrdreUpdatePage {
  pageTitle = element(by.id('perma-sous-ordre-heading'));
...
export class SousOrdreDeleteDialog {
  private dialogTitle = element(by.id('perma-delete-sousOrdre-heading'));
  private confirmButton = element(by.id('perma-confirm-delete-sousOrdre'));
