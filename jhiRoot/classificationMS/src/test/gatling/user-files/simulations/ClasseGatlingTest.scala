...
class ClasseGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Classe entity")
        ...
        .repeat(2) {
            ...
            .get("/services/classificationms/api/classes")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new classe")
            .post("/services/classificationms/api/classes")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "nomFr":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/classificationms${new_classe_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created classe")
            .delete("/services/classificationms${new_classe_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
