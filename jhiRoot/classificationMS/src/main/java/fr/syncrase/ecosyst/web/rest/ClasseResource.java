...
import fr.syncrase.ecosyst.service.ClasseService;
...
/**
 * REST controller for managing {@link fr.syncrase.ecosyst.domain.Classe}.
 */
@RestController
@RequestMapping("/api")
public class ClasseResource {
    ...
    private static final String ENTITY_NAME = "classificationMsClasse";
     ...
     */
    @GetMapping("/classes")
    public ResponseEntity<List<Classe>> getAllClasses(ClasseCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Classes by criteria: {}", criteria);
        Page<Classe> page = classeQueryService.findByCriteria(criteria, pageable);
