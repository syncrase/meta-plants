package fr.syncrase.ecosyst.domain.classification.entities.wrapper;
...
import fr.syncrase.ecosyst.domain.classification.entities.mappers.ClassificationNomMapper;
import fr.syncrase.ecosyst.domain.classification.entities.mappers.UrlMapper;
...
import static fr.syncrase.ecosyst.domain.classification.entities.database.CronquistRank.DEFAULT_NAME_FOR_CONNECTOR_RANK;
