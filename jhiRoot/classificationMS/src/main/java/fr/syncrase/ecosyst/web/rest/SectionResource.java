...
import fr.syncrase.ecosyst.service.SectionService;
...
/**
 * REST controller for managing {@link fr.syncrase.ecosyst.domain.Section}.
 */
@RestController
@RequestMapping("/api")
public class SectionResource {
    ...
    private static final String ENTITY_NAME = "classificationMsSection";
