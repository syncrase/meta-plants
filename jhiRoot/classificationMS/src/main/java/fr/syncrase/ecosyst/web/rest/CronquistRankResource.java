...
import fr.syncrase.ecosyst.service.database.CronquistRankService;
...
/**
 * REST controller for managing {@link CronquistRank}.
 */
@RestController
@RequestMapping("/api")
public class CronquistRankResource {
    ...
    private static final String ENTITY_NAME = "classificationMsCronquistRank";
    ...
    public ResponseEntity<CronquistRank> updateCronquistRank(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cronquistRank.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CronquistRank> partialUpdateCronquistRank(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cronquistRank.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<CronquistRank>> getAllCronquistRanks(CronquistRankCriteria criteria, Pageable pageable) {
