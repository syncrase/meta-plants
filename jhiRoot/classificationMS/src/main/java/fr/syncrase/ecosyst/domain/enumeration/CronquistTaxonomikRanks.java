...
public enum CronquistTaxonomikRanks {
    SUPERREGNE("SuperRegne"), REGNE("Regne"), SOUSREGNE("SousRegne"), RAMEAU("Rameau"), INFRAREGNE("InfraRegne"), SUPEREMBRANCHEMENT("SuperEmbranchement"), EMBRANCHEMENT("Embranchement"), SOUSEMBRANCHEMENT("SousEmbranchement"), INFRAEMBRANCHEMENT("InfraEmbranchement"), MICROEMBRANCHEMENT("MicroEmbranchement"), SUPERCLASSE("SuperClasse"), CLASSE("Classe"), SOUSCLASSE("SousClasse"), INFRACLASSE("InfraClasse"), SUPERORDRE("SuperOrdre"), ORDRE("Ordre"), SOUSORDRE("SousOrdre"), INFRAORDRE("InfraOrdre"), MICROORDRE("MicroOrdre"), SUPERFAMILLE("SuperFamille"), FAMILLE("Famille"), SOUSFAMILLE("SousFamille"), TRIBU("Tribu"), SOUSTRIBU("SousTribu"), GENRE("Genre"), SOUSGENRE("SousGenre"), SECTION("Section"), SOUSSECTION("SousSection"), ESPECE("Espece"), SOUSESPECE("SousEspece"), VARIETE("Variete"), SOUSVARIETE("SousVariete"), FORME("Forme"), SOUSFORME("SousForme");
