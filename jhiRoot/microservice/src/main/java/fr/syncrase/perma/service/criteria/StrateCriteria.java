...
/**
 * Criteria class for the {@link fr.syncrase.perma.domain.Strate} entity. This class is used
 * in {@link fr.syncrase.perma.web.rest.StrateResource} to receive all the possible filtering options from
