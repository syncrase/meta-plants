...
/**
 * Criteria class for the {@link fr.syncrase.perma.domain.Reproduction} entity. This class is used
 * in {@link fr.syncrase.perma.web.rest.ReproductionResource} to receive all the possible filtering options from
