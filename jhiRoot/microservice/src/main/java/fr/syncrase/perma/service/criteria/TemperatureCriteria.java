...
/**
 * Criteria class for the {@link fr.syncrase.perma.domain.Temperature} entity. This class is used
 * in {@link fr.syncrase.perma.web.rest.TemperatureResource} to receive all the possible filtering options from
