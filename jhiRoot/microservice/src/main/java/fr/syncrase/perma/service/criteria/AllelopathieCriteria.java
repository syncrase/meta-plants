...
public class AllelopathieCriteria implements Serializable, Criteria {
    ...
    private LongFilter interactionId;
    ...
    public LongFilter getInteractionId() {
        return interactionId;
    }

    public LongFilter interactionId() {
        if (interactionId == null) {
            interactionId = new LongFilter();
        }
        return interactionId;
    }

    public void setInteractionId(LongFilter interactionId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, type, description, cibleId, origineId, interactionId, distinct);
    }
