...
class TemperatureGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Temperature entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/temperatures")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new temperature")
            .post("/services/microservice/api/temperatures")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "min":"0"
                , "max":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_temperature_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created temperature")
            .delete("/services/microservice${new_temperature_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
