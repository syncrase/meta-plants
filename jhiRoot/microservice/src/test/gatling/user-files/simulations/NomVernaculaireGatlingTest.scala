...
class NomVernaculaireGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the NomVernaculaire entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/nom-vernaculaires")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new nomVernaculaire")
            .post("/services/microservice/api/nom-vernaculaires")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "nom":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_nomVernaculaire_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created nomVernaculaire")
            .delete("/services/microservice${new_nomVernaculaire_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
