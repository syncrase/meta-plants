...
class AllelopathieGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Allelopathie entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/allelopathies")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new allelopathie")
            .post("/services/microservice/api/allelopathies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "type":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_allelopathie_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created allelopathie")
            .delete("/services/microservice${new_allelopathie_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
