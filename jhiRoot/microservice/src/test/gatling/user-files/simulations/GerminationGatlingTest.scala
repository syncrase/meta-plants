...
class GerminationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Germination entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservice/api/germinations")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new germination")
            .post("/services/microservice/api/germinations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/microservice${new_germination_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created germination")
            .delete("/services/microservice${new_germination_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
