...
class SolResourceIT {
    ...
    void createSol() throws Exception {
        ...
        restSolMockMvc
            .perform(
                post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(solDTO))
            )
    ...
    void putNewSol() throws Exception {
        ...
        restSolMockMvc
            .perform(
                put(ENTITY_API_URL_ID, solDTO.getId())
                    .with(csrf())
    ...
    void putWithMissingIdPathParamSol() throws Exception {
        ...
        restSolMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(solDTO))
            )
    ...
    void patchNonExistingSol() throws Exception {
        ...
        restSolMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, solDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(solDTO))
            )
    ...
    void deleteSol() throws Exception {
        ...
        // Delete the sol
        restSolMockMvc
            .perform(delete(ENTITY_API_URL_ID, sol.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
