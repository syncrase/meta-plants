...
class APGIVResourceIT {
    ...
    void putNewAPGIV() throws Exception {
        ...
        restAPGIVMockMvc
            .perform(
                put(ENTITY_API_URL_ID, aPGIVDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(aPGIVDTO))
            )
    ...
    void patchNonExistingAPGIV() throws Exception {
        ...
        restAPGIVMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, aPGIVDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(aPGIVDTO))
            )
    ...
    void deleteAPGIV() throws Exception {
        ...
        // Delete the aPGIV
        restAPGIVMockMvc
            .perform(delete(ENTITY_API_URL_ID, aPGIV.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
